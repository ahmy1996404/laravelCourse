...
// portifolio page route
Route::get('/portifolio', [AboutController::class, 'Portifolio'])->name('portifolio');
// admin contact page
...
Route::post('/contcat/form', [ContactController::class, 'ContactForm'])->name('contact.form');
...
// user profile
Route::get('/profile/user', [ChangePassController::class, 'PUpdate'])->name('profile.update');
Route::post('/profile/user/update', [ChangePassController::class, 'UpdateProfile'])->name('user.profile.update');
